...
export default function Modal({
  ...
  return (
    <motion.div
      ...
      className="fixed inset-0 z-40 flex justify-center items-center p-4 bg-slate-900 bg-opacity-80 cursor-pointer"
      onClick={(e) => {
    ...
    >
      <div className="w-full max-w-5xl cursor-auto">
        <button
          className="modal-close rounded-md mb-1 hover:text-sky-500 hover:bg-sky-950 h-12 w-12 flex justify-center items-center "
        ...
        <motion.div
          ...
          className="flex justify-start items-stretch p-4 rounded-lg modal"
        >
          <div className="flex flex-col justify-start items-start w-2/3 gap-8 p-4 ps-2 pe-10">
